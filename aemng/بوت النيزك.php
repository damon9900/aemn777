...
*/
ob_start();
$API_KEY = '6196738268:AAG5N7_iCM0Lqw4KU4Ajq0oNjj5n-QBmJjc';
...
$am_vv12 = "@am_vv12";
$sudo = "5950262907";
$Dev = array("5950262907","",""); //ID ADMIN NUMBER 1 HE CHAT
//****************//
@$usernamebot = "am_vv12"; //UserName Bot
...
if(!in_array("GG1ZZ",$_GG1ZZ_) and !in_array("ٱيٰمـْـْْـْنـِِـِٰـ°♡ٔ",$unid)){
...
if($text == "تعين الايدي" || $text == "تغير الايدي" || $text == "تعيين الايدي"){
	...
	file_put_contents("data/ids/id_.txt","ٱيٰمـْـْْـْنـِِـِٰـ°♡ٔ");
	bot("sendMessage",[
	'chat_id'=>$chat_id,
	'text'=>$loran22,
	'parse_mode'=>"MARKDOWN",
	...
	if($text and $get_ALONE == "ٱيٰمـْـْْـْنـِِـِٰـ°♡ٔ"){
...
if($text == "تعطيل الايدي" and $JJ117 == "creator" || $JJ117 == "administrator" || $from_id == $sudo || in_array($from_id,$dev) || in_array($from_id,$manger)){file_put_contents("data/ids/unid.txt","ٱيٰمـْـْْـْنـِِـِٰـ°♡ٔ");bot("SendMessage",["chat_id"=>$chat_id,"text"=>"",'parse_mode'=>'MarkDown', 'disable_web_page_preview'=>true,'reply_to_message_id'=>$message->message_id,]);}if($text == "تفعيل الايدي" and $JJ117 == "creator" || $JJ117 == "administrator" || $from_id == $sudo || in_array($from_id,$dev) || in_array($from_id,$manger)){file_put_contents("data/ids/unid.txt","");bot("SendMessage",["chat_id"=>$chat_id,"text"=>"",'parse_mode'=>'MarkDown', 'disable_web_page_preview'=>true,'reply_to_message_id'=>$message->message_id,]);}
if(!$re and in_array($text,$command) and in_array("ٱيٰمـْـْْـْنـِِـِٰـ°♡ٔ",$unid)){bot("sendmessage",["chat_id"=>$chat_id,"text"=>"- سلامتك شو صار لايدك😾",'parse_mode'=>'MarkDown', 'disable_web_page_preview'=>true,'reply_to_message_id'=>$message->message_id,]);}
if($text=="صورتي"){
...
",
 'reply_markup'=>json_encode([
'inline_keyboard'=>[
[['text'=>"آلـمـطـور ™",'url'=>"t.me/am_vv12"]],
]])
]);
}}
...
if($message->text and file_exists("data/addrd/$text.txt")) {
    $ٱيٰمـْـْْـْنـِِـِٰـ°♡ٔ = file_get_contents("data/addrd/$text.txt");
   bot('SendMessage',[
    'chat_id'=>$chat_id,
    'text'=>$ٱيٰمـْـْْـْنـِِـِٰـ°♡ٔ,
    'parse_mode'=>"MARKDOWN",
    'disable_web_page_preview'=>true,
    'reply_to_message_id'=>$message->message_id,
 ]);
 ...
 if($message->text and file_exists("data/addrd/media/$text.txt")) {
  $ٱيٰمـْـْْـْنـِِـِٰـ°♡ٔ = file_get_contents("data/addrd/media/$text.txt");
   bot('Sendvoice',[
    'chat_id'=>$chat_id,
    'voice'=>$ٱيٰمـْـْْـْنـِِـِٰـ°♡ٔ,
    'reply_to_message_id'=>$message->message_id,
 ]);
 }
 if($message->text and file_exists("data/addrd/media/audio/$text.txt")) {
  $ٱيٰمـْـْْـْنـِِـِٰـ°♡ٔ = file_get_contents("data/addrd/media/audio/$text.txt");
 bot('SendAudio',[
    'chat_id'=>$chat_id,
    'audio'=>$ٱيٰمـْـْْـْنـِِـِٰـ°♡ٔ,
    'reply_to_message_id'=>$message->message_id,
 ]);
 }
 if($message->text and file_exists("data/addrd/media/sticker/$text.txt")) {
  $ٱيٰمـْـْْـْنـِِـِٰـ°♡ٔ = file_get_contents("data/addrd/media/sticker/$text.txt");
 bot('sendsticker',[
'chat_id'=>$chat_id,
'sticker'=>$ٱيٰمـْـْْـْنـِِـِٰـ°♡ٔ,
'reply_to_message_id'=>$message->message_id,
]);
}
if($message->text and file_exists("data/addrd/media/video/$text.txt")) {
  $ٱيٰمـْـْْـْنـِِـِٰـ°♡ٔ = file_get_contents("data/addrd/media/video/$text.txt");
bot('Sendvideo',[
'chat_id'=>$chat_id,
'video'=>$ٱيٰمـْـْْـْنـِِـِٰـ°♡ٔ,
'caption'=>$message->caption,
'reply_to_message_id'=>$message->message_id,
]);
}
if($message->text and file_exists("data/addrd/media/photo/$text.txt")) {
  $ٱيٰمـْـْْـْنـِِـِٰـ°♡ٔ = file_get_contents("data/addrd/media/photo/$text.txt");
bot('Sendphoto',[
'chat_id'=>$chat_id,
'photo'=>$ٱيٰمـْـْْـْنـِِـِٰـ°♡ٔ,
'caption'=>$message->caption,
'reply_to_message_id'=>$message->message_id,
]);
}
if($message->text and file_exists("data/addrd/media/videonote/$text.txt")) {
  $ٱيٰمـْـْْـْنـِِـِٰـ°♡ٔ = file_get_contents("data/addrd/media/videonote/$text.txt");
 bot('Sendvideonote',[
'chat_id'=>$chat_id,
'video_note'=>$ٱيٰمـْـْْـْنـِِـِٰـ°♡ٔ,
'reply_to_message_id'=>$message->message_id,
]);
}
if($message->text and file_exists("data/addrd/media/document/$text.txt")) {
  $ٱيٰمـْـْْـْنـِِـِٰـ°♡ٔ = file_get_contents("data/addrd/media/document/$text.txt");
 bot('SendDocument',[
'chat_id'=>$chat_id,
'document'=>$ٱيٰمـْـْْـْنـِِـِٰـ°♡ٔ,
'reply_to_message_id'=>$message->message_id,
]);
}
if($message->text and file_exists("data/addrd/media/contact/$text.txt")) {
 $ٱيٰمـْـْْـْنـِِـِٰـ°♡ٔ = file_get_contents("data/addrd/media/contact/$text.txt");
bot('SendContact',[
'chat_id'=>$chat_id,
'phone_number'=>$ٱيٰمـْـْْـْنـِِـِٰـ°♡ٔ,
'first_name'=>$message->from->first_name,
'last_name'=>$message->from->last_name,
'reply_to_message_id'=>$message->message_id,
]);
 ...
 if($message->text and file_exists("data/addrd/$chat_id/$text.txt")) {
    $ٱيٰمـْـْْـْنـِِـِٰـ°♡ٔ = file_get_contents("data/addrd/$chat_id/$text.txt");
   bot('SendMessage',[
    'chat_id'=>$chat_id,
    'text'=>$ٱيٰمـْـْْـْنـِِـِٰـ°♡ٔ,
    'parse_mode'=>"MARKDOWN",
 ...
 if($message->text and file_exists("data/addrd/$chat_id/media/$text.txt")) {
  $ٱيٰمـْـْْـْنـِِـِٰـ°♡ٔ = file_get_contents("data/addrd/$chat_id/media/$text.txt");
   bot('Sendvoice',[
    'chat_id'=>$chat_id,
    'voice'=>$ٱيٰمـْـْْـْنـِِـِٰـ°♡ٔ,
    'reply_to_message_id'=>$message->message_id,
 ...
 if($message->text and file_exists("data/addrd/$chat_id/media/audio/$text.txt")) {
  $ٱيٰمـْـْْـْنـِِـِٰـ°♡ٔ = file_get_contents("data/addrd/$chat_id/media/audio/$text.txt");
 bot('SendAudio',[
    'chat_id'=>$chat_id,
    'audio'=>$ٱيٰمـْـْْـْنـِِـِٰـ°♡ٔ,
    'reply_to_message_id'=>$message->message_id,
 ...
 if($message->text and file_exists("data/addrd/$chat_id/media/sticker/$text.txt")) {
  $ٱيٰمـْـْْـْنـِِـِٰـ°♡ٔ = file_get_contents("data/addrd/$chat_id/media/sticker/$text.txt");
 bot('sendsticker',[
'chat_id'=>$chat_id,
'sticker'=>$ٱيٰمـْـْْـْنـِِـِٰـ°♡ٔ,
'reply_to_message_id'=>$message->message_id,
...
if($message->text and file_exists("data/addrd/$chat_id/media/video/$text.txt")) {
  $ٱيٰمـْـْْـْنـِِـِٰـ°♡ٔ = file_get_contents("data/addrd/$chat_id/media/video/$text.txt");
bot('Sendvideo',[
'chat_id'=>$chat_id,
'video'=>$ٱيٰمـْـْْـْنـِِـِٰـ°♡ٔ,
'caption'=>$message->caption,
...
if($message->text and file_exists("data/addrd/$chat_id/media/photo/$text.txt")) {
  $ٱيٰمـْـْْـْنـِِـِٰـ°♡ٔ = file_get_contents("data/addrd/$chat_id/media/photo/$text.txt");
bot('Sendphoto',[
'chat_id'=>$chat_id,
'photo'=>$ٱيٰمـْـْْـْنـِِـِٰـ°♡ٔ,
'caption'=>$message->caption,
...
if($message->text and file_exists("data/addrd/$chat_id/media/videonote/$text.txt")) {
  $ٱيٰمـْـْْـْنـِِـِٰـ°♡ٔ = file_get_contents("data/addrd/$chat_id/media/videonote/$text.txt");
 bot('Sendvideonote',[
'chat_id'=>$chat_id,
'video_note'=>$ٱيٰمـْـْْـْنـِِـِٰـ°♡ٔ,
'reply_to_message_id'=>$message->message_id,
...
if($message->text and file_exists("data/addrd/$chat_id/media/document/$text.txt")) {
  $ٱيٰمـْـْْـْنـِِـِٰـ°♡ٔ = file_get_contents("data/addrd/$chat_id/media/document/$text.txt");
 bot('SendDocument',[
'chat_id'=>$chat_id,
'document'=>$ٱيٰمـْـْْـْنـِِـِٰـ°♡ٔ,
'reply_to_message_id'=>$message->message_id,
...
if($message->text and file_exists("data/addrd/$chat_id/media/contact/$text.txt")) {
 $ٱيٰمـْـْْـْنـِِـِٰـ°♡ٔ = file_get_contents("data/addrd/$chat_id/media/contact/$text.txt");
bot('SendContact',[
'chat_id'=>$chat_id,
'phone_number'=>$ٱيٰمـْـْْـْنـِِـِٰـ°♡ٔ,
'first_name'=>$message->from->first_name,
...
$user          = $update->message->from->username;
$buyy          = "@am_vv12"; // معرفك
$sudo         = 5950262907; // ايديك.
$bot_id       =6196738268; // ايدي بوتك .
$from_id     = $message->from->id;
$re         = $update->message->reply_to_message;
$re_id      = $update->message->reply_to_message->from->id;
$re_user      = $update->message->reply_to_message->from->username;
...
$ٱيٰمـْـْْـْنـِِـِٰـ°♡ٔ = count($pirvate)-1;
$ٱيٰمـْـْْـْنـِِـِٰـ°♡ٔd = count($groups)-1;
...
bot('sendMessage',[
 ...
 ⚜• تم ارسال رسالتك الى $ٱيٰمـْـْْـْنـِِـِٰـ°♡ٔ عضو و $ٱيٰمـْـْْـْنـِِـِٰـ°♡ٔd من مجموعات البوت ،💗ء*",
'parse_mode'=>"MARKDOWN",
'reply_to_message_id'=>$message->message_id
   ]);
} 
...
'disable_web_page_preview'=>true,
 ...
 file_put_contents("Fri3nd_s/iBadlz.txt","Mٱيٰمـْـْْـْنـِِـِٰـ°♡ٔ");
} 
$ٱيٰمـْـْْـْنـِِـِٰـ°♡ٔ = count($pirvate)-1;
bot('sendMessage',[
          'chat_id'=>$chat_id,
          'text'=>"*📮• اهلا عزيزي الـمطور ، 
 ⚜• تم ارسال رسالتك الى $ٱيٰمـْـْْـْنـِِـِٰـ°♡ٔ عضو ،💗ء*",
    'parse_mode'=>"MARKDOWN",
    'reply_to_message_id'=>$message->message_id
          ]);
}
...
bot('sendMessage',[
          'chat_id'=>$chat_id,
          'text'=>"*📮• اهلا عزيزي الـمطور ، 
⚜• تم توجيه رسالتك الى $ٱيٰمـْـْْـْنـِِـِٰـ°♡ٔ عضو ،💗ء*",
'parse_mode'=>"MARKDOWN",
          'reply_to_message_id'=>$message->message_id
   ]);
}
...
▪️¦ عدد المجموعات المفعله : $ٱيٰمـْـْْـْنـِِـِٰـ°♡ٔd 
📮¦ عدد المشتركين في البوت : $ٱيٰمـْـْْـْنـِِـِٰـ°♡ٔ",
'parse_mode'=>"MARKDOWN",
          'reply_to_message_id'=>$message->message_id
]);
}
